-- Data Atual
-- SELECT CURRENT_DATE Data_atual;
...
-- SELECT CURRENT_DATE - INTERVAL '3 DAY' AS Data_Matrícula;

-- SELECT CURRENT_DATE - INTERVAL '1 MONTH' AS Data_Matrícula;

-- SELECT CURRENT_DATE - INTERVAL '2 YEAR' AS Data_Matrícula;
...
-- Em meses
-- SELECT (DATE_PART('year', '2019-01-01'::date) - DATE_PART('year', '2011-10-02'::date)) * 12 + (DATE_PART('month', '2019-01-01'::date) - DATE_PART('month', '2011-10-02'::date)) AS Em_meses;
